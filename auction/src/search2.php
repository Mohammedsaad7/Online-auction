...
<body>
  <header>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="userlog">HOME
    ...
    <div>
  	<h2 class=he>Search by Name</h2>
  </div>
  <form method="post" action="namedisp.php">
  	<div class="input-group">
  		<label>Name</label>
  		<input type="text" name="nam" >
  	</div>
  	<div class="input-group">
  		<button type="submit" class="but" name="names">Search</button>
  	</div>
  </form>
</header>
</body>
